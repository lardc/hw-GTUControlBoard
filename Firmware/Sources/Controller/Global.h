...
//--------------------------------------------------------
#define REGLTR_KI_THR_ERROR				_IQ(0.1f)		// Уровень ошибки отключения интегральной составляющей регулятора (в %)
#define REGLTR_KI_H_THR_ERROR			_IQ(0.5f)		// Уровень ошибки, когда интегральная составляющая сбрасывается в крайние значения
...
#define REGULATOR_ERROR_I_SAT_H			_IQ(30000.0f)	// Значение насыщения для интегральной составляющей регулятора
//--------------------------------------------------------
